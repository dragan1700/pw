...
Since PW stores files in site/assets/files/page-id/ and not under the virtual URL domain.com/page/sub-page/pagename/, finding all file-folders manually can be tedious.
